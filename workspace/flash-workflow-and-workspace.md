...
- (Illustrator, InCopy, InDesign, Photoshop) To hide or show all panels except
  ...
  ![](../img/tip_help.png) You can temporarily display hidden panels if
...
![](../img/dingbat.png) Click the panel menu icon ![](../img/panel_menu.png) in
the upper-right corner of the panel.

![](../img/tip_help.png) You can open a panel menu even when the panel is
minimized.

![](../img/tip_help.png) In Photoshop, you can change the font size of the text
in panels and tool tips. In the Interface preferences, choose a size from the UI
Font Size menu.

### (Illustrator) Adjust panel brightness

![](../img/dingbat.png)  In User Interface preferences, move the Brightness
...
![](../img/tip_help.png) In InDesign and InCopy, you also can switch from
single-column to double-column (or single-row) display by setting an option in
Interface preferences.

![](../img/dingbat.png)  Click the double arrow at the top of the Tools panel.
...
- To remove a panel or panel group, drag it out of the dock by its tab or title
  ...
  ![](../img/swa_drag_new_dock.png)

  Navigator panel being dragged out to new dock, indicated by blue vertical
  highlight

  ![](../img/swa_own_dock.png)

  Navigator panel now in its own dock

![](../img/tip_help.png) You can prevent panels from filling all the space in a
...
![](../img/tip_help.png) Press Ctrl (Windows) or Command (Mac OS) while moving a
...
![](../img/swa_panels_collapsed.png)

<caption>Panels collapsed to icons</caption>

![](../img/swa_panels_expanded.png)
...
- To collapse an expanded panel back to its icon, click its tab, its icon, or
  ...
  ![](../img/tip_help.png) In some products, if you select Auto-Collapse Icon
...
![](../img/dingbat.png) Select a workspace from the workspace switcher in the
Application bar. ![](../img/tip_help.png) In Photoshop, you can assign keyboard
...
- To restore all the workspaces installed with Photoshop, click Restore Default
  Workspaces in the Interface preferences. ![](../img/tip_help.png) To rearrange
