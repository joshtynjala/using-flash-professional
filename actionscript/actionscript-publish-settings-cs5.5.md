...
- Windows XP: Hard Disk\Documents and Settings\\_user_\Local
  Settings\Application Data\Adobe\Flash CS5.5\\_language_\Configuration\Classes

- Windows Vista: Hard Disk\Users\\_user_\Local Settings\Application
  Data\Adobe\Flash CS5.5\\_language_\Configuration\Classes

- Macintosh: Hard Disk/Users/_user_/Library/Application Support/Adobe/Flash
  CS5.5/_language_/Configuration/Classes
...
- Windows XP: Hard Disk\Documents and Settings\\_user_\Local
  Settings\Application Data\Adobe\Flash CS5.5\\_language_\Configuration\Include

- Windows Vista: Hard Disk\Users\\_user_\Local Settings\Application
  Data\Adobe\Flash CS5.5\\_language_\Configuration\Include

- Macintosh: Hard Disk/Users/_user_/Library/Application Support/Adobe/Flash
  CS5.5/_language_/Configuration/Include
...
- Windows XP: Hard Disk\Documents and Settings\\_user_\Local
  ...
  CS5.5\\_language_\Configuration\ActionsPanel

- Windows Vista: Hard Disk\Users\\_user_\Local Settings\Application
  Data\Adobe\Flash CS5.5\\_language_\Configuration\ActionsPanel
...
[Learning ActionScript 2.0 in Adobe Flash](https://web.archive.org/web/20120121073137mp_/http://www.adobe.com/go/learn_cs5_learningas2_en)
or
"[Packages](https://web.archive.org/web/20120121073137mp_/http://help.adobe.com/en_US/as3/learn/WS5b3ccc516d4fbf351e63e3d118a9b90204-7f94.html)"
...
2.  Make sure ActionScript 3.0 is specified in the Script menu and click the
    ActionScript Settings button.
...
2.  Ensure that the Script menu set to ActionScript 3.0 and click the Settings
    button next to the menu.

3.  In the Advanced ActionScript 3.0 Settings dialog box, click the Config
    Constants tab.

4.  To add a constant, click the Add button.

5.  Type the name of the constant you want to add. The default config namespace
...
6.  Enter the value you want for the constant, either true or false. You change
...
> SWF file is loaded. You cannot customize this menu.

Customize context menus in Flash Player 7 by using the ContextMenu and
ContextMenuItem objects in ActionScript 2.0. For more information on using these
objects, see `ContextMenu` in the
[_ActionScript 2.0 Language Reference_](https://web.archive.org/web/20120121073137mp_/http://www.adobe.com/go/learn_cs5_as2lr_en).
